...
""" !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    run ROC_pt20to5_MuDependence.py to adjust JVF marker positions
...
#    funkylabel         = "#DeltaR(#mu,jet)>1"
    ...
    if True:
        ...
        canvas.Update()
        marker1 = ROOT.TMarker()
        marker1.SetMarkerStyle(29)
        marker1.SetMarkerSize(2.5)
        marker1.SetMarkerColor(ROOT.kPink-1)
        marker1.SetX(0.974309514185)
        marker1.SetY(0.0871836399528)
        marker1.Draw("same")
        marker2 = ROOT.TMarker()
        marker2.SetMarkerStyle(29)
        marker2.SetMarkerSize(2.5)
        marker2.SetMarkerColor(ROOT.kAzure+10)
        marker2.SetX(0.916432309595)
        marker2.SetY(0.0252689061727)
        marker2.Draw("same")
