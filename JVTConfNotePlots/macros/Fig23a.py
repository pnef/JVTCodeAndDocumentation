...
if __name__ == "__main__":
    ...
    fT_new     = path+"skimmedPt20to50Eta2p4.20140213.00.12_PileUpStudies_rev351681.PythJ1and2mc12aJETMET.jetmet2012pileupcustom.kNN20140213.root"
    ...
    treevariable          = [ "fabs(JnPUTrkCorrJVF)"  ,"fabs(JnPUTrkCorrJVF)"   ,"fabs(JnPUTrkCorrJVF)"   ]
    VarName               = [ "corrJVF, Trk-to-Vtx 1" ,"corrJVF, Trk-to-Vtx 2"  ,"corrJVF, Trk-to-Vtx 3"  ] 
    nBins                 = [  100                    , 100                     , 100                     ] 
    binMin                = [ -1                      ,-1                       ,-1                       ] 
    binMax                = [ 1.1                     ,1.1                      ,1.1                      ] 
    ...
    if True:
        for ptlow, pthigh in zip(ptBinsLow,ptBinsHigh):
            ...
            for VarIndex,Var in zip(range(len(treevariable)),treevariable):
                ...
                plotter.H_["Var_ROC_fromTree_"+VarName[VarIndex]].h_.SetMinimum(0.01)
                plotter.H_["Var_ROC_fromTree_"+VarName[VarIndex]].h_.SetMaximum(5)
