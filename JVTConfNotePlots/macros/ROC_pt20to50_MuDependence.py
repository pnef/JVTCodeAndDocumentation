...
#    funkylabel         = "#DeltaR(#mu,jet)>1"
    ...
    plotter.COLORSSolid  = [ROOT.kTeal-5, ROOT.kMagenta+3, ROOT.kViolet+9, ROOT.kPink, ROOT.kOrange+1]
    ...
    plotter.MARKERSSolid = [20, 29, 29, 29]
...
#        canvas, leg = plotter.Draw(listROC,"Efficiency", "Fake Rate", False, True, [MClabel, jetlabel, etalabel, ptlabel ], VarName)
        ...
        canvas, leg = plotter.Draw(listROC+["Var_ROC_fromTree_JVF>0.5","Var_ROC_fromTree_JVT>0.2"],"Efficiency", "Fake Rate", False, True, [MClabel, jetlabel, etalabel, ptlabel, "     JVF>0.5 (N_{Vtx} bins)", "     JVT>0.7 (N_{Vtx} bins)" ], 
