...
#    funkylabel         = "#DeltaR(#mu,jet)>1"
    ...
    for VarIndex,Var in zip(range(len(treevariable)),treevariable):
        ...
        if(HSonTheRight[VarIndex]):
            plotter.EfficiencyVsNPV("HS_Var_EffFake_FromTree"+str(VarIndex), 2, -99, -99, 0.4,  -99, "HS_Var_EffFake_effVal"+str(VarIndex))
            plotter.EfficiencyVsNPV("PU_Var_EffFake_FromTree"+str(VarIndex), 4, -99, -99, 0.4,  -99, "PU_Var_EffFake_effVal"+str(VarIndex))
        else:
            plotter.EfficiencyVsNPV("HS_Var_EffFake_FromTree"+str(VarIndex), 2, -99, -99, -99, 0.4,  "HS_Var_EffFake_effVal"+str(VarIndex))
            plotter.EfficiencyVsNPV("PU_Var_EffFake_FromTree"+str(VarIndex), 4, -99, -99, -99, 0.4,  "PU_Var_EffFake_effVal"+str(VarIndex))
