...
if __name__ == "__main__":
    ...
    treeSelectionROC_PU   = " NPV>=5 && JisPU &&  fabs(Jeta)<2.4 && Jpt<30 && Jpt>20 && VtxDzTruth<0.1 "
    treeSelectionROC_HS   = " NPV>=5 && JisHS &&  fabs(Jeta)<2.4 && Jpt<30 && Jpt>20 && VtxDzTruth<0.1 && Jtruthpt >10"
    ...
    selection             = ""
    treevariable          = [  "JJVF",   "JnPUTrkCorrJVF" ,  "JHSPVtrkSumOverPt"  , "kNN100trim_pt20to50_Likelihood" ]  
