        ...
        for varIndex,var in zip(range(len(treevariable)),treevariable):
            for ptbin,ptlow,pthigh in zip(range(len(ptBinsLow)),ptBinsLow,ptBinsHigh):
                ...
                for npvbin,npvlow,npvhigh in zip(range(len(npvBinsLow)),npvBinsLow,npvBinsHigh):
                    ...
                    selection_HS_q = "Weight*("+treeSelection_HS + "&& (Jpt >"+str(ptlow)+"&& Jpt<"+str(pthigh)+"&& NPV >"+str(npvlow)+"&& NPV<"+str(npvhigh)+" && JisParton_uds))"
                    selection_HS_g = "Weight*("+treeSelection_HS + "&& (Jpt >"+str(ptlow)+"&& Jpt<"+str(pthigh)+"&& NPV >"+str(npvlow)+"&& NPV<"+str(npvhigh)+" && JisParton_g))"
                    ...
                    plotter.H_[histHS_q].h_.SetMinimum(0.0001)
                    plotter.H_[histHS_q].h_.SetMaximum(100)
                    plotter.H_[histHS_g].h_.SetMinimum(0.0001)
                    plotter.H_[histHS_g].h_.SetMaximum(100)
