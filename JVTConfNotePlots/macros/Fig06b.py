...
if __name__ == "__main__":
    ...
    selection             = ""
    treevariable          = [  "JJVF"                    , "kNN100trim_pt20to50_Likelihood"]  
    VarName               = [  "JVF"                     , "JVT"                           ] 
    nBins                 = [   500                      ,  1000                           ] 
    binMin                = [  -1                        , -0.1                            ] 
    binMax                = [  1.1                       , 1.1                             ] 
    ...
    tfiles                = [  fT                        , fT                              ]
    additionalCutPU       = [  "&&Jpt<30 && Jpt>20"      , "&&Jpt<30 && Jpt>20"            ]
    additionalCutHS       = [  "&&Jpt<30 && Jpt>20"      , "&&Jpt<30 && Jpt>20"            ]
...
#    funkylabel         = "#DeltaR(#mu,jet)>1"
    ...
    if True:
        ...
        plotter.Draw(H_PU_Var_EffFake, 
                "N_{Vtx}", "Fake Rate",  False, True, [MClabel, jetlabel, ptLegend+etalabel, efflabel], 
                Cuts_Var_EffFake)
