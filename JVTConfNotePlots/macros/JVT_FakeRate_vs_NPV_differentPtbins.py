...
#    funkylabel         = "#DeltaR(#mu,jet)>1"
    ...
    for VarIndex,Var in zip(range(len(treevariable)),treevariable):
        ...
        plotter.GetHistoFromTree("PU_Var_EffFake_FromTree"+str(VarIndex), tfiles[VarIndex],  putree , Var+":Jpt:"+EffFakeVsVar, SelectionNPVdep_PU , 7 ,5,35,50,0,100,nBins[VarIndex],binMin[VarIndex],binMax[VarIndex])
        ...
        if(HSonTheRight[VarIndex]):
            plotter.EfficiencyVsNPV("HS_Var_EffFake_FromTree"+str(VarIndex), 2, -99, -99, JVTCutVal,  -99, "HS_Var_EffFake_effVal"+str(VarIndex))
            plotter.EfficiencyVsNPV("PU_Var_EffFake_FromTree"+str(VarIndex), 1, -99, -99, JVTCutVal,  -99, "PU_Var_EffFake_effVal"+str(VarIndex))
        else:
            plotter.EfficiencyVsNPV("HS_Var_EffFake_FromTree"+str(VarIndex), 2, -99, -99, -99, JVTCutVal,  "HS_Var_EffFake_effVal"+str(VarIndex))
            plotter.EfficiencyVsNPV("PU_Var_EffFake_FromTree"+str(VarIndex), 1, -99, -99, -99, JVTCutVal,  "PU_Var_EffFake_effVal"+str(VarIndex))
    ...
    plotter.Draw(H_PU_Var_EffFake, 
            "N_{Vtx}", "Fake Rate",  False, True, [MClabel, jetlabel, etalabel+ptLegend, efflabel], 
            Cuts_Var_EffFake)
