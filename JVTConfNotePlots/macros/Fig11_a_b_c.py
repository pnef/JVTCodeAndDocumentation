...
if __name__ == "__main__":
    ...
    # ----------------- SIGNAL ----------------------------------------------------
    signalSelection = "fabs(J0ZDPhi) >2.6 && ZPt>30 && Jpt>20 && Jpt<50 && fabs(Jeta)<2.4 && Jindex==0 "; doSignal = True
    ...
    plotter.SetMCScale(ScaleFact,    ["JVFMC_HS"])
    plotter.SetMCScale(ScaleFact,    ["JVFMC_PU","JVFMC_other"])

    plotter.DataToMC(["JVFMC_HS", "JVFMC_PU","JVFMC_other"], "JVFData" , "JVT", "Events", [lumiLabel,MClabel,jetlabel,"20<p_{T}<50 GeV, |#eta|<2.4", "Z p_{T}>30 GeV", "HS enriched selection"], [ "HS", "PU", "other"])
    ...
    plotter.DataToMC(["JVFMC_HS", "JVFMC_PU","JVFMC_other"], "JVFData" , "corrJVF", "Events", [lumiLabel,MClabel,jetlabel,"20<p_{T}<50 GeV, |#eta|<2.4", "Z p_{T}>30 GeV", "HS enriched selection"], ["HS", "PU", "other"])
    ...
    plotter.DataToMC(["JVFMC_HS", "JVFMC_PU","JVFMC_other"], "JVFData" , "R_{pT}", "Events", [lumiLabel,MClabel,jetlabel,"20<p_{T}<50 GeV, |#eta|<2.4", "Z p_{T}>30 GeV", "HS enriched selection"], ["HS", "PU", "other"])
