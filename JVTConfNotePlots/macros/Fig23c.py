...
if __name__ == "__main__":
    ...
    additionalCutPU       = [ ""                      ,""                       ,""                 ] 
    additionalCutHS       = [ "&&JisParton_b"       ," &&JisParton_b"           ,"&&JisParton_b  "  ]
    ...
    if True:
        for ptlow, pthigh in zip(ptBinsLow,ptBinsHigh):
            ...
            plotter.Draw(listROC,"Efficiency", "Fake Rate", False, True, [MClabel, jetlabel, etalabel, ptlabel, "b-quark initiated jets"], VarName)
