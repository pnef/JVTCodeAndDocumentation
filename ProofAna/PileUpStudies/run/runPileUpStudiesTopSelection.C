...
void runPileUpStudiesTopSelection(TString mode       = "cluster",         // local, lite, or cluster
TString identifier = "PileUpStudies_TopSelection_rev360615",    
// --------------- Data -------------
...
//TString dataset    = "PowhegPythia_ttbar_LeptonFilterSMWZ.jetmet2012pileupcustom",
//TString dataset   = "McAtNloJimmy_CT10_ttbar_LeptonFilterSMWZ_short.jetmet2012pileupcustom",
//TString dataset   = "McAtNloJimmy_CT10_ttbar_LeptonFilterSMWZ.jetmet2012pileupcustom",
//------------- Single Top -------------------
//TString dataset   = "SingleTopFullSMWZ_small.jetmet2012pileupcustom",
//TString dataset   = "SingleTopFullSMWZ.jetmet2012pileupcustom",
// ---------------- WJets ----------------
//TString dataset   = "WJetsFullSMWZ_small.jetmet2012pileupcustom",
TString dataset   = "WJetsFullSMWZ.jetmet2012pileupcustom",
// ------------------------------------------------------------------------------------------------
TString username   = "pnef",                               // username (e.g. swiatlow, fizisist)
bool mcweights     = true,                                 // use mc weights?
bool debug         = false,                                // debug mode
Long64_t nentries  = 1000000,                              // nevents
bool doPRW         = true,
int      nworkers  = -1,
bool fullLumi      = true
    ) 
{ 
    ...
    TopSelection->Set("DONOJVFCUT", 1); // no JVF cut applied for jet selection
...
//    chain->Add("ANALYSIS",PileUpStudiesEventTreeFiller);
    ...
    chain->Set("doTopSelection"    , doTopSelection);
