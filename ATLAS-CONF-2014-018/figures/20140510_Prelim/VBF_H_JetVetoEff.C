...
//=========  (Sun May 11 01:39:20 2014) by ROOT version5.32/00
   ...
   gre->SetPoint(0,2.5,0.8509358);
   gre->SetPointError(0,0,0.02384968);
   gre->SetPoint(1,7.5,0.8590075);
   gre->SetPointError(1,0,0.01109992);
   gre->SetPoint(2,12.5,0.856496);
   gre->SetPointError(2,0,0.007338999);
   gre->SetPoint(3,17.5,0.8540863);
   gre->SetPointError(3,0,0.007740469);
   gre->SetPoint(4,22.5,0.8455393);
   gre->SetPointError(4,0,0.0126823);
   gre->SetPoint(5,27.5,0.8245856);
   gre->SetPointError(5,0,0.03374804);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,0,30);
   Graph_Graph3->SetMinimum(0.7824428);
   Graph_Graph3->SetMaximum(0.8831803);
   ...
   gre->SetPoint(0,2.5,0.940508);
   gre->SetPointError(0,0,0.02507353);
   gre->SetPoint(1,7.5,0.9465003);
   gre->SetPointError(1,0,0.0116515);
   gre->SetPoint(2,12.5,0.9493146);
   gre->SetPointError(2,0,0.007726436);
   gre->SetPoint(3,17.5,0.9504735);
   gre->SetPointError(3,0,0.008165568);
   gre->SetPoint(4,22.5,0.942743);
   gre->SetPointError(4,0,0.01339145);
   gre->SetPoint(5,27.5,0.9378453);
   gre->SetPointError(5,0,0.0359912);
   
   TH1F *Graph_Graph4 = new TH1F("Graph_Graph4","Graph",100,0,30);
   Graph_Graph4->SetMinimum(0.8946559);
   Graph_Graph4->SetMaximum(0.9810347);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.2,0.7,"open markers: JVT>0.7");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.03);
   tex->SetLineWidth(2);
