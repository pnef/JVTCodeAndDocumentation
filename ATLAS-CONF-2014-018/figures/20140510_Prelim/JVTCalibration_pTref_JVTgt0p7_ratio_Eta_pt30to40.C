...
//=========  (Sun May 11 01:26:59 2014) by ROOT version5.32/00
   TCanvas *c1 = new TCanvas("c1", "Histogram Drawing Options",373,138,600,800);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: pad1
   ...
   EffRecoCorrSystSmooth->SetBinContent(1,0.8756335);
   EffRecoCorrSystSmooth->SetBinContent(2,0.8838672);
   EffRecoCorrSystSmooth->SetBinContent(3,0.875599);
   EffRecoCorrSystSmooth->SetBinContent(4,0.8917002);
   EffRecoCorrSystSmooth->SetBinContent(5,0.8901572);
   EffRecoCorrSystSmooth->SetBinContent(6,0.8958532);
   EffRecoCorrSystSmooth->SetBinContent(7,0.8944094);
   EffRecoCorrSystSmooth->SetBinContent(8,0.8875822);
   EffRecoCorrSystSmooth->SetBinContent(9,0.8660835);
   EffRecoCorrSystSmooth->SetBinContent(10,0.8693377);
   EffRecoCorrSystSmooth->SetBinError(1,0.0134082);
   EffRecoCorrSystSmooth->SetBinError(2,0.0137505);
   EffRecoCorrSystSmooth->SetBinError(3,0.01443545);
   EffRecoCorrSystSmooth->SetBinError(4,0.01619871);
   EffRecoCorrSystSmooth->SetBinError(5,0.01912691);
   EffRecoCorrSystSmooth->SetBinError(6,0.01919718);
   EffRecoCorrSystSmooth->SetBinError(7,0.01634638);
   EffRecoCorrSystSmooth->SetBinError(8,0.01445655);
   EffRecoCorrSystSmooth->SetBinError(9,0.01390042);
   EffRecoCorrSystSmooth->SetBinError(10,0.01387662);
   ...
   EffRecoCorr->SetBinContent(1,0.8756335);
   EffRecoCorr->SetBinContent(2,0.8838672);
   EffRecoCorr->SetBinContent(3,0.875599);
   EffRecoCorr->SetBinContent(4,0.8917002);
   EffRecoCorr->SetBinContent(5,0.8901572);
   EffRecoCorr->SetBinContent(6,0.8958532);
   EffRecoCorr->SetBinContent(7,0.8944094);
   EffRecoCorr->SetBinContent(8,0.8875822);
   EffRecoCorr->SetBinContent(9,0.8660835);
   EffRecoCorr->SetBinContent(10,0.8693377);
   EffRecoCorr->SetBinError(1,0.009065939);
   EffRecoCorr->SetBinError(2,0.008225056);
   EffRecoCorr->SetBinError(3,0.007611918);
   EffRecoCorr->SetBinError(4,0.006773411);
   EffRecoCorr->SetBinError(5,0.007020739);
   EffRecoCorr->SetBinError(6,0.006922398);
   EffRecoCorr->SetBinError(7,0.00702621);
   EffRecoCorr->SetBinError(8,0.007375966);
   EffRecoCorr->SetBinError(9,0.008754094);
   EffRecoCorr->SetBinError(10,0.009816834);
   ...
   EffDataCorr->SetBinContent(1,0.8684403);
   EffDataCorr->SetBinContent(2,0.8690538);
   EffDataCorr->SetBinContent(3,0.8731367);
   EffDataCorr->SetBinContent(4,0.8926272);
   EffDataCorr->SetBinContent(5,0.8956451);
   EffDataCorr->SetBinContent(6,0.887787);
   EffDataCorr->SetBinContent(7,0.8850731);
   EffDataCorr->SetBinContent(8,0.8779576);
   EffDataCorr->SetBinContent(9,0.8733202);
   EffDataCorr->SetBinContent(10,0.8686134);
   EffDataCorr->SetBinError(1,0.003831236);
   EffDataCorr->SetBinError(2,0.0034188);
   EffDataCorr->SetBinError(3,0.00303549);
   EffDataCorr->SetBinError(4,0.002721685);
   EffDataCorr->SetBinError(5,0.00263098);
   EffDataCorr->SetBinError(6,0.002697191);
   EffDataCorr->SetBinError(7,0.002800871);
   EffDataCorr->SetBinError(8,0.003065301);
   EffDataCorr->SetBinError(9,0.00335817);
   EffDataCorr->SetBinError(10,0.003857994);
...
// ------------>Primitives in pad: pad2
   ...
   EffRecoCorrSystSmoothuncert__1->SetBinError(1,0.01531257);
   EffRecoCorrSystSmoothuncert__1->SetBinError(2,0.0155572);
   EffRecoCorrSystSmoothuncert__1->SetBinError(3,0.01648637);
   EffRecoCorrSystSmoothuncert__1->SetBinError(4,0.01816609);
   EffRecoCorrSystSmoothuncert__1->SetBinError(5,0.02148711);
   EffRecoCorrSystSmoothuncert__1->SetBinError(6,0.02142893);
   EffRecoCorrSystSmoothuncert__1->SetBinError(7,0.01827618);
   EffRecoCorrSystSmoothuncert__1->SetBinError(8,0.01628756);
   EffRecoCorrSystSmoothuncert__1->SetBinError(9,0.01604975);
   EffRecoCorrSystSmoothuncert__1->SetBinError(10,0.01596229);
   ...
   EffRecoCorrSystSmoothuncert->SetBinError(1,0.01531257);
   EffRecoCorrSystSmoothuncert->SetBinError(2,0.0155572);
   EffRecoCorrSystSmoothuncert->SetBinError(3,0.01648637);
   EffRecoCorrSystSmoothuncert->SetBinError(4,0.01816609);
   EffRecoCorrSystSmoothuncert->SetBinError(5,0.02148711);
   EffRecoCorrSystSmoothuncert->SetBinError(6,0.02142893);
   EffRecoCorrSystSmoothuncert->SetBinError(7,0.01827618);
   EffRecoCorrSystSmoothuncert->SetBinError(8,0.01628756);
   EffRecoCorrSystSmoothuncert->SetBinError(9,0.01604975);
   EffRecoCorrSystSmoothuncert->SetBinError(10,0.01596229);
   ...
   MCsumRatio->SetBinContent(1,0.9917851);
   MCsumRatio->SetBinContent(2,0.9832402);
   MCsumRatio->SetBinContent(3,0.9971879);
   MCsumRatio->SetBinContent(4,1.00104);
   MCsumRatio->SetBinContent(5,1.006165);
   MCsumRatio->SetBinContent(6,0.9909961);
   MCsumRatio->SetBinContent(7,0.9895615);
   MCsumRatio->SetBinContent(8,0.9891564);
   MCsumRatio->SetBinContent(9,1.008356);
   MCsumRatio->SetBinContent(10,0.9991668);
   MCsumRatio->SetBinError(1,0.0158045);
   MCsumRatio->SetBinError(2,0.01577794);
   MCsumRatio->SetBinError(3,0.01680156);
   MCsumRatio->SetBinError(4,0.01843935);
   MCsumRatio->SetBinError(5,0.02182068);
   MCsumRatio->SetBinError(6,0.02144835);
   MCsumRatio->SetBinError(7,0.01835451);
   MCsumRatio->SetBinError(8,0.01647694);
   MCsumRatio->SetBinError(9,0.01664186);
   MCsumRatio->SetBinError(10,0.0165549);
   MCsumRatio->SetEntries(30819.84);
