...
//=========  (Sun May 11 01:22:04 2014) by ROOT version5.32/00
   TCanvas *c1 = new TCanvas("c1", "Histogram Drawing Options",627,170,600,800);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: pad1
   ...
   EffRecoCorrSystSmooth->SetBinContent(1,0.908952);
   EffRecoCorrSystSmooth->SetBinContent(2,0.9282261);
   EffRecoCorrSystSmooth->SetBinContent(3,0.9417055);
   EffRecoCorrSystSmooth->SetBinContent(4,0.9550551);
   EffRecoCorrSystSmooth->SetBinContent(5,0.9628439);
   EffRecoCorrSystSmooth->SetBinContent(6,0.9647615);
   EffRecoCorrSystSmooth->SetBinContent(7,0.9724021);
   EffRecoCorrSystSmooth->SetBinContent(8,0.9743665);
   EffRecoCorrSystSmooth->SetBinContent(9,0.9779477);
   EffRecoCorrSystSmooth->SetBinError(1,0.01474496);
   EffRecoCorrSystSmooth->SetBinError(2,0.01156693);
   EffRecoCorrSystSmooth->SetBinError(3,0.01045252);
   EffRecoCorrSystSmooth->SetBinError(4,0.009494301);
   EffRecoCorrSystSmooth->SetBinError(5,0.008115274);
   EffRecoCorrSystSmooth->SetBinError(6,0.007222598);
   EffRecoCorrSystSmooth->SetBinError(7,0.007335949);
   EffRecoCorrSystSmooth->SetBinError(8,0.00843438);
   EffRecoCorrSystSmooth->SetBinError(9,0.001388114);
   ...
   EffRecoCorr->SetBinContent(1,0.908952);
   EffRecoCorr->SetBinContent(2,0.9282261);
   EffRecoCorr->SetBinContent(3,0.9417055);
   EffRecoCorr->SetBinContent(4,0.9550551);
   EffRecoCorr->SetBinContent(5,0.9628439);
   EffRecoCorr->SetBinContent(6,0.9647615);
   EffRecoCorr->SetBinContent(7,0.9724021);
   EffRecoCorr->SetBinContent(8,0.9743665);
   EffRecoCorr->SetBinContent(9,0.9779477);
   EffRecoCorr->SetBinError(1,0.01283761);
   EffRecoCorr->SetBinError(2,0.007652219);
   EffRecoCorr->SetBinError(3,0.004905931);
   EffRecoCorr->SetBinError(4,0.003844695);
   EffRecoCorr->SetBinError(5,0.003100277);
   EffRecoCorr->SetBinError(6,0.002819242);
   EffRecoCorr->SetBinError(7,0.002590013);
   EffRecoCorr->SetBinError(8,0.002964847);
   EffRecoCorr->SetBinError(9,0.001388114);
   ...
   EffDataCorr->SetBinContent(1,0.8930835);
   EffDataCorr->SetBinContent(2,0.9213525);
   EffDataCorr->SetBinContent(3,0.9404325);
   EffDataCorr->SetBinContent(4,0.9498634);
   EffDataCorr->SetBinContent(5,0.9595685);
   EffDataCorr->SetBinContent(6,0.9680341);
   EffDataCorr->SetBinContent(7,0.9685306);
   EffDataCorr->SetBinContent(8,0.9723851);
   EffDataCorr->SetBinContent(9,0.9758406);
   EffDataCorr->SetBinError(1,0.001461533);
   EffDataCorr->SetBinError(2,0.001183365);
   EffDataCorr->SetBinError(3,0.001045196);
   EffDataCorr->SetBinError(4,0.001001846);
   EffDataCorr->SetBinError(5,0.001016077);
   EffDataCorr->SetBinError(6,0.00106414);
   EffDataCorr->SetBinError(7,0.001231476);
   EffDataCorr->SetBinError(8,0.001428047);
   EffDataCorr->SetBinError(9,0.0009158846);
...
// ------------>Primitives in pad: pad2
   ...
   EffRecoCorrSystSmoothuncert__1->SetBinContent(9,0.9779477);
   EffRecoCorrSystSmoothuncert__1->SetBinError(1,0.01622194);
   EffRecoCorrSystSmoothuncert__1->SetBinError(2,0.01246133);
   EffRecoCorrSystSmoothuncert__1->SetBinError(3,0.01109957);
   EffRecoCorrSystSmoothuncert__1->SetBinError(4,0.009941103);
   EffRecoCorrSystSmoothuncert__1->SetBinError(5,0.008428441);
   EffRecoCorrSystSmoothuncert__1->SetBinError(6,0.007486408);
   EffRecoCorrSystSmoothuncert__1->SetBinError(7,0.007544151);
   EffRecoCorrSystSmoothuncert__1->SetBinError(8,0.008656271);
   EffRecoCorrSystSmoothuncert__1->SetBinError(9,0.001388114);
   ...
   EffRecoCorrSystSmoothuncert->SetBinContent(9,0.9779477);
   EffRecoCorrSystSmoothuncert->SetBinError(1,0.01622194);
   EffRecoCorrSystSmoothuncert->SetBinError(2,0.01246133);
   EffRecoCorrSystSmoothuncert->SetBinError(3,0.01109957);
   EffRecoCorrSystSmoothuncert->SetBinError(4,0.009941103);
   EffRecoCorrSystSmoothuncert->SetBinError(5,0.008428441);
   EffRecoCorrSystSmoothuncert->SetBinError(6,0.007486408);
   EffRecoCorrSystSmoothuncert->SetBinError(7,0.007544151);
   EffRecoCorrSystSmoothuncert->SetBinError(8,0.008656271);
   EffRecoCorrSystSmoothuncert->SetBinError(9,0.001388114);
   ...
   MCsumRatio->SetBinContent(1,0.982542);
   MCsumRatio->SetBinContent(2,0.992595);
   MCsumRatio->SetBinContent(3,0.9986482);
   MCsumRatio->SetBinContent(4,0.994564);
   MCsumRatio->SetBinContent(5,0.9965981);
   MCsumRatio->SetBinContent(6,1.003392);
   MCsumRatio->SetBinContent(7,0.9960187);
   MCsumRatio->SetBinContent(8,0.9979664);
   MCsumRatio->SetBinContent(9,0.9978454);
   MCsumRatio->SetBinError(1,0.01601964);
   MCsumRatio->SetBinError(2,0.01243458);
   MCsumRatio->SetBinError(3,0.01113999);
   MCsumRatio->SetBinError(4,0.009942555);
   MCsumRatio->SetBinError(5,0.008465799);
   MCsumRatio->SetBinError(6,0.007592353);
   MCsumRatio->SetBinError(7,0.00762009);
   MCsumRatio->SetBinError(8,0.008762112);
   MCsumRatio->SetBinError(9,0.00169799);
   MCsumRatio->SetEntries(70571.86);
