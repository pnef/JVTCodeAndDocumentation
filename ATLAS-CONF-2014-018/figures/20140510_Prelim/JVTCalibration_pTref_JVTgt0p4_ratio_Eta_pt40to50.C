...
//=========  (Sun May 11 01:25:49 2014) by ROOT version5.32/00
   TCanvas *c1 = new TCanvas("c1", "Histogram Drawing Options",521,142,600,800);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: pad1
   ...
   EffRecoCorrSystSmooth->SetBinContent(1,0.9293491);
   EffRecoCorrSystSmooth->SetBinContent(2,0.9403358);
   EffRecoCorrSystSmooth->SetBinContent(3,0.9407675);
   EffRecoCorrSystSmooth->SetBinContent(4,0.949379);
   EffRecoCorrSystSmooth->SetBinContent(5,0.9513992);
   EffRecoCorrSystSmooth->SetBinContent(6,0.9409114);
   EffRecoCorrSystSmooth->SetBinContent(7,0.9610737);
   EffRecoCorrSystSmooth->SetBinContent(8,0.9510873);
   EffRecoCorrSystSmooth->SetBinContent(9,0.9409294);
   EffRecoCorrSystSmooth->SetBinContent(10,0.9424954);
   EffRecoCorrSystSmooth->SetBinError(1,0.0122952);
   EffRecoCorrSystSmooth->SetBinError(2,0.009155785);
   EffRecoCorrSystSmooth->SetBinError(3,0.006461869);
   EffRecoCorrSystSmooth->SetBinError(4,0.005211218);
   EffRecoCorrSystSmooth->SetBinError(5,0.009365715);
   EffRecoCorrSystSmooth->SetBinError(6,0.009436296);
   EffRecoCorrSystSmooth->SetBinError(7,0.005090432);
   EffRecoCorrSystSmooth->SetBinError(8,0.005994344);
   EffRecoCorrSystSmooth->SetBinError(9,0.009352599);
   EffRecoCorrSystSmooth->SetBinError(10,0.01265803);
   ...
   EffRecoCorr->SetBinContent(1,0.9293491);
   EffRecoCorr->SetBinContent(2,0.9403358);
   EffRecoCorr->SetBinContent(3,0.9407675);
   EffRecoCorr->SetBinContent(4,0.949379);
   EffRecoCorr->SetBinContent(5,0.9513992);
   EffRecoCorr->SetBinContent(6,0.9409114);
   EffRecoCorr->SetBinContent(7,0.9610737);
   EffRecoCorr->SetBinContent(8,0.9510873);
   EffRecoCorr->SetBinContent(9,0.9409294);
   EffRecoCorr->SetBinContent(10,0.9424954);
   EffRecoCorr->SetBinError(1,0.007444523);
   EffRecoCorr->SetBinError(2,0.006805285);
   EffRecoCorr->SetBinError(3,0.006303113);
   EffRecoCorr->SetBinError(4,0.005179511);
   EffRecoCorr->SetBinError(5,0.005337308);
   EffRecoCorr->SetBinError(6,0.005577866);
   EffRecoCorr->SetBinError(7,0.00505716);
   EffRecoCorr->SetBinError(8,0.005819015);
   EffRecoCorr->SetBinError(9,0.007064506);
   EffRecoCorr->SetBinError(10,0.007857902);
   ...
   EffDataCorr->SetBinContent(1,0.9310099);
   EffDataCorr->SetBinContent(2,0.9360977);
   EffDataCorr->SetBinContent(3,0.9456024);
   EffDataCorr->SetBinContent(4,0.9507679);
   EffDataCorr->SetBinContent(5,0.9518951);
   EffDataCorr->SetBinContent(6,0.9537671);
   EffDataCorr->SetBinContent(7,0.9536959);
   EffDataCorr->SetBinContent(8,0.940019);
   EffDataCorr->SetBinContent(9,0.9425442);
   EffDataCorr->SetBinContent(10,0.9280632);
   EffDataCorr->SetBinError(1,0.003699107);
   EffDataCorr->SetBinError(2,0.003128179);
   EffDataCorr->SetBinError(3,0.002647281);
   EffDataCorr->SetBinError(4,0.002394656);
   EffDataCorr->SetBinError(5,0.00235149);
   EffDataCorr->SetBinError(6,0.002359483);
   EffDataCorr->SetBinError(7,0.002396445);
   EffDataCorr->SetBinError(8,0.002811808);
   EffDataCorr->SetBinError(9,0.002962463);
   EffDataCorr->SetBinError(10,0.003768467);
...
// ------------>Primitives in pad: pad2
   ...
   EffRecoCorrSystSmoothuncert__1->SetBinError(1,0.0132299);
   EffRecoCorrSystSmoothuncert__1->SetBinError(2,0.009736719);
   EffRecoCorrSystSmoothuncert__1->SetBinError(3,0.006868721);
   EffRecoCorrSystSmoothuncert__1->SetBinError(4,0.005489081);
   EffRecoCorrSystSmoothuncert__1->SetBinError(5,0.009844148);
   EffRecoCorrSystSmoothuncert__1->SetBinError(6,0.01002889);
   EffRecoCorrSystSmoothuncert__1->SetBinError(7,0.005296609);
   EffRecoCorrSystSmoothuncert__1->SetBinError(8,0.006302622);
   EffRecoCorrSystSmoothuncert__1->SetBinError(9,0.009939746);
   EffRecoCorrSystSmoothuncert__1->SetBinError(10,0.01343033);
   ...
   EffRecoCorrSystSmoothuncert->SetBinError(1,0.0132299);
   EffRecoCorrSystSmoothuncert->SetBinError(2,0.009736719);
   EffRecoCorrSystSmoothuncert->SetBinError(3,0.006868721);
   EffRecoCorrSystSmoothuncert->SetBinError(4,0.005489081);
   EffRecoCorrSystSmoothuncert->SetBinError(5,0.009844148);
   EffRecoCorrSystSmoothuncert->SetBinError(6,0.01002889);
   EffRecoCorrSystSmoothuncert->SetBinError(7,0.005296609);
   EffRecoCorrSystSmoothuncert->SetBinError(8,0.006302622);
   EffRecoCorrSystSmoothuncert->SetBinError(9,0.009939746);
   EffRecoCorrSystSmoothuncert->SetBinError(10,0.01343033);
   ...
   MCsumRatio->SetBinContent(1,1.001787);
   MCsumRatio->SetBinContent(2,0.995493);
   MCsumRatio->SetBinContent(3,1.005139);
   MCsumRatio->SetBinContent(4,1.001463);
   MCsumRatio->SetBinContent(5,1.000521);
   MCsumRatio->SetBinContent(6,1.013663);
   MCsumRatio->SetBinContent(7,0.9923233);
   MCsumRatio->SetBinContent(8,0.9883625);
   MCsumRatio->SetBinContent(9,1.001716);
   MCsumRatio->SetBinContent(10,0.9846872);
   MCsumRatio->SetBinError(1,0.01383833);
   MCsumRatio->SetBinError(2,0.01024782);
   MCsumRatio->SetBinError(3,0.00745546);
   MCsumRatio->SetBinError(4,0.006048175);
   MCsumRatio->SetBinError(5,0.01015466);
   MCsumRatio->SetBinError(6,0.01047063);
   MCsumRatio->SetBinError(7,0.005817437);
   MCsumRatio->SetBinError(8,0.006895235);
   MCsumRatio->SetBinError(9,0.01044273);
   MCsumRatio->SetBinError(10,0.01381591);
   MCsumRatio->SetEntries(101453.5);
