...
//=========  (Sun May 11 01:23:51 2014) by ROOT version5.32/00
   TCanvas *c1 = new TCanvas("c1", "Histogram Drawing Options",503,131,600,800);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: pad1
   ...
   EffRecoCorrSystSmooth->SetBinContent(1,0.9404836);
   EffRecoCorrSystSmooth->SetBinContent(2,0.9467166);
   EffRecoCorrSystSmooth->SetBinContent(3,0.9456986);
   EffRecoCorrSystSmooth->SetBinContent(4,0.9451804);
   EffRecoCorrSystSmooth->SetBinContent(5,0.9554889);
   EffRecoCorrSystSmooth->SetBinContent(6,0.954462);
   EffRecoCorrSystSmooth->SetBinContent(7,0.9508945);
   EffRecoCorrSystSmooth->SetBinContent(8,0.9441716);
   EffRecoCorrSystSmooth->SetBinContent(9,0.9423866);
   EffRecoCorrSystSmooth->SetBinContent(10,0.9465993);
   EffRecoCorrSystSmooth->SetBinError(1,0.01009464);
   EffRecoCorrSystSmooth->SetBinError(2,0.01142375);
   EffRecoCorrSystSmooth->SetBinError(3,0.01246149);
   EffRecoCorrSystSmooth->SetBinError(4,0.01313146);
   EffRecoCorrSystSmooth->SetBinError(5,0.01396237);
   EffRecoCorrSystSmooth->SetBinError(6,0.01396279);
   EffRecoCorrSystSmooth->SetBinError(7,0.01323906);
   EffRecoCorrSystSmooth->SetBinError(8,0.01239175);
   EffRecoCorrSystSmooth->SetBinError(9,0.01153193);
   EffRecoCorrSystSmooth->SetBinError(10,0.01039398);
   EffRecoCorrSystSmooth->SetMinimum(0.8);
   EffRecoCorrSystSmooth->SetMaximum(1.1);
   EffRecoCorrSystSmooth->SetEntries(46444);
   ...
   EffRecoCorr->SetBinContent(1,0.9404836);
   EffRecoCorr->SetBinContent(2,0.9467166);
   EffRecoCorr->SetBinContent(3,0.9456986);
   EffRecoCorr->SetBinContent(4,0.9451804);
   EffRecoCorr->SetBinContent(5,0.9554889);
   EffRecoCorr->SetBinContent(6,0.954462);
   EffRecoCorr->SetBinContent(7,0.9508945);
   EffRecoCorr->SetBinContent(8,0.9441716);
   EffRecoCorr->SetBinContent(9,0.9423866);
   EffRecoCorr->SetBinContent(10,0.9465993);
   EffRecoCorr->SetBinError(1,0.007615074);
   EffRecoCorr->SetBinError(2,0.00714846);
   EffRecoCorr->SetBinError(3,0.006512626);
   EffRecoCorr->SetBinError(4,0.005926101);
   EffRecoCorr->SetBinError(5,0.006040484);
   EffRecoCorr->SetBinError(6,0.006069562);
   EffRecoCorr->SetBinError(7,0.006024203);
   EffRecoCorr->SetBinError(8,0.006406658);
   EffRecoCorr->SetBinError(9,0.007369431);
   EffRecoCorr->SetBinError(10,0.007971799);
   EffRecoCorr->SetMinimum(0.913329);
   EffRecoCorr->SetMaximum(1.032434);
   EffRecoCorr->SetEntries(46444);
   ...
   EffDataCorr->SetBinContent(1,0.9288596);
   EffDataCorr->SetBinContent(2,0.9394581);
   EffDataCorr->SetBinContent(3,0.940797);
   EffDataCorr->SetBinContent(4,0.9538573);
   EffDataCorr->SetBinContent(5,0.9531129);
   EffDataCorr->SetBinContent(6,0.9517993);
   EffDataCorr->SetBinContent(7,0.9488463);
   EffDataCorr->SetBinContent(8,0.9446253);
   EffDataCorr->SetBinContent(9,0.9391894);
   EffDataCorr->SetBinContent(10,0.9285981);
   EffDataCorr->SetBinError(1,0.003032421);
   EffDataCorr->SetBinError(2,0.002525538);
   EffDataCorr->SetBinError(3,0.002301057);
   EffDataCorr->SetBinError(4,0.002003042);
   EffDataCorr->SetBinError(5,0.001987758);
   EffDataCorr->SetBinError(6,0.001992163);
   EffDataCorr->SetBinError(7,0.002089945);
   EffDataCorr->SetBinError(8,0.002318245);
   EffDataCorr->SetBinError(9,0.002496184);
   EffDataCorr->SetBinError(10,0.003023983);
   EffDataCorr->SetMinimum(0.913329);
   EffDataCorr->SetMaximum(1.032434);
   EffDataCorr->SetEntries(126811);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.2,0.66,"30 < p_{T}^{ref} < 40 GeV");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.03);
   tex->SetLineWidth(2);
...
// ------------>Primitives in pad: pad2
   ...
   EffRecoCorrSystSmoothuncert__1->SetBinError(1,0.01073345);
   EffRecoCorrSystSmoothuncert__1->SetBinError(2,0.0120667);
   EffRecoCorrSystSmoothuncert__1->SetBinError(3,0.01317702);
   EffRecoCorrSystSmoothuncert__1->SetBinError(4,0.01389307);
   EffRecoCorrSystSmoothuncert__1->SetBinError(5,0.0146128);
   EffRecoCorrSystSmoothuncert__1->SetBinError(6,0.01462896);
   EffRecoCorrSystSmoothuncert__1->SetBinError(7,0.01392275);
   EffRecoCorrSystSmoothuncert__1->SetBinError(8,0.01312447);
   EffRecoCorrSystSmoothuncert__1->SetBinError(9,0.01223694);
   EffRecoCorrSystSmoothuncert__1->SetBinError(10,0.01098034);
   EffRecoCorrSystSmoothuncert__1->SetMinimum(0.96);
   EffRecoCorrSystSmoothuncert__1->SetMaximum(1.04);
   EffRecoCorrSystSmoothuncert__1->SetEntries(46454);
   ...
   EffRecoCorrSystSmoothuncert->SetBinError(1,0.01073345);
   EffRecoCorrSystSmoothuncert->SetBinError(2,0.0120667);
   EffRecoCorrSystSmoothuncert->SetBinError(3,0.01317702);
   EffRecoCorrSystSmoothuncert->SetBinError(4,0.01389307);
   EffRecoCorrSystSmoothuncert->SetBinError(5,0.0146128);
   EffRecoCorrSystSmoothuncert->SetBinError(6,0.01462896);
   EffRecoCorrSystSmoothuncert->SetBinError(7,0.01392275);
   EffRecoCorrSystSmoothuncert->SetBinError(8,0.01312447);
   EffRecoCorrSystSmoothuncert->SetBinError(9,0.01223694);
   EffRecoCorrSystSmoothuncert->SetBinError(10,0.01098034);
   EffRecoCorrSystSmoothuncert->SetMinimum(0.96);
   EffRecoCorrSystSmoothuncert->SetMaximum(1.04);
   EffRecoCorrSystSmoothuncert->SetEntries(46454);
   ...
   MCsumRatio->SetBinContent(1,0.9876404);
   MCsumRatio->SetBinContent(2,0.992333);
   MCsumRatio->SetBinContent(3,0.994817);
   MCsumRatio->SetBinContent(4,1.00918);
   MCsumRatio->SetBinContent(5,0.9975133);
   MCsumRatio->SetBinContent(6,0.9972102);
   MCsumRatio->SetBinContent(7,0.997846);
   MCsumRatio->SetBinContent(8,1.00048);
   MCsumRatio->SetBinContent(9,0.9966073);
   MCsumRatio->SetBinContent(10,0.9809832);
   MCsumRatio->SetBinError(1,0.0110803);
   MCsumRatio->SetBinError(2,0.01226775);
   MCsumRatio->SetBinError(3,0.01333263);
   MCsumRatio->SetBinError(4,0.01417986);
   MCsumRatio->SetBinError(5,0.01472417);
   MCsumRatio->SetBinError(6,0.01473671);
   MCsumRatio->SetBinError(7,0.01406554);
   MCsumRatio->SetBinError(8,0.01335836);
   MCsumRatio->SetBinError(9,0.01247976);
   MCsumRatio->SetBinError(10,0.01123526);
   MCsumRatio->SetEntries(56809.34);
