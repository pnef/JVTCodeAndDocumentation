...
//=========  (Sun May 11 01:25:31 2014) by ROOT version5.32/00
   TCanvas *c1 = new TCanvas("c1", "Histogram Drawing Options",269,81,600,800);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: pad1
   ...
   EffRecoCorrSystSmooth->SetBinContent(1,0.9203643);
   EffRecoCorrSystSmooth->SetBinContent(2,0.9192347);
   EffRecoCorrSystSmooth->SetBinContent(3,0.9235256);
   EffRecoCorrSystSmooth->SetBinContent(4,0.9266777);
   EffRecoCorrSystSmooth->SetBinContent(5,0.9309652);
   EffRecoCorrSystSmooth->SetBinContent(6,0.9310787);
   EffRecoCorrSystSmooth->SetBinContent(7,0.9311077);
   EffRecoCorrSystSmooth->SetBinContent(8,0.9247776);
   EffRecoCorrSystSmooth->SetBinContent(9,0.916533);
   EffRecoCorrSystSmooth->SetBinContent(10,0.9202347);
   EffRecoCorrSystSmooth->SetBinError(1,0.009381335);
   EffRecoCorrSystSmooth->SetBinError(2,0.01112261);
   EffRecoCorrSystSmooth->SetBinError(3,0.01279853);
   EffRecoCorrSystSmooth->SetBinError(4,0.01460252);
   EffRecoCorrSystSmooth->SetBinError(5,0.01719996);
   EffRecoCorrSystSmooth->SetBinError(6,0.01721199);
   EffRecoCorrSystSmooth->SetBinError(7,0.0147232);
   EffRecoCorrSystSmooth->SetBinError(8,0.01272485);
   EffRecoCorrSystSmooth->SetBinError(9,0.01130463);
   EffRecoCorrSystSmooth->SetBinError(10,0.009892087);
   ...
   EffRecoCorr->SetBinContent(1,0.9203643);
   EffRecoCorr->SetBinContent(2,0.9192347);
   EffRecoCorr->SetBinContent(3,0.9235256);
   EffRecoCorr->SetBinContent(4,0.9266777);
   EffRecoCorr->SetBinContent(5,0.9309652);
   EffRecoCorr->SetBinContent(6,0.9310787);
   EffRecoCorr->SetBinContent(7,0.9311077);
   EffRecoCorr->SetBinContent(8,0.9247776);
   EffRecoCorr->SetBinContent(9,0.916533);
   EffRecoCorr->SetBinContent(10,0.9202347);
   EffRecoCorr->SetBinError(1,0.008142784);
   EffRecoCorr->SetBinError(2,0.007691179);
   EffRecoCorr->SetBinError(3,0.006920046);
   EffRecoCorr->SetBinError(4,0.00624533);
   EffRecoCorr->SetBinError(5,0.006458523);
   EffRecoCorr->SetBinError(6,0.0064857);
   EffRecoCorr->SetBinError(7,0.00639323);
   EffRecoCorr->SetBinError(8,0.006759589);
   EffRecoCorr->SetBinError(9,0.007975927);
   EffRecoCorr->SetBinError(10,0.008726682);
   ...
   EffDataCorr->SetBinContent(1,0.9069958);
   EffDataCorr->SetBinContent(2,0.9111433);
   EffDataCorr->SetBinContent(3,0.9164156);
   EffDataCorr->SetBinContent(4,0.9304118);
   EffDataCorr->SetBinContent(5,0.931626);
   EffDataCorr->SetBinContent(6,0.9283708);
   EffDataCorr->SetBinContent(7,0.9263421);
   EffDataCorr->SetBinContent(8,0.919155);
   EffDataCorr->SetBinContent(9,0.9143802);
   EffDataCorr->SetBinContent(10,0.9056591);
   EffDataCorr->SetBinError(1,0.003358171);
   EffDataCorr->SetBinError(2,0.002937101);
   EffDataCorr->SetBinError(3,0.002604612);
   EffDataCorr->SetBinError(4,0.002317652);
   EffDataCorr->SetBinError(5,0.00226057);
   EffDataCorr->SetBinError(6,0.002288785);
   EffDataCorr->SetBinError(7,0.002378418);
   EffDataCorr->SetBinError(8,0.002643802);
   EffDataCorr->SetBinError(9,0.002868573);
   EffDataCorr->SetBinError(10,0.003382696);
...
// ------------>Primitives in pad: pad2
   ...
   EffRecoCorrSystSmoothuncert__1->SetBinError(1,0.01019307);
   EffRecoCorrSystSmoothuncert__1->SetBinError(2,0.01209986);
   EffRecoCorrSystSmoothuncert__1->SetBinError(3,0.01385834);
   EffRecoCorrSystSmoothuncert__1->SetBinError(4,0.01575793);
   EffRecoCorrSystSmoothuncert__1->SetBinError(5,0.01847541);
   EffRecoCorrSystSmoothuncert__1->SetBinError(6,0.01848607);
   EffRecoCorrSystSmoothuncert__1->SetBinError(7,0.01581257);
   EffRecoCorrSystSmoothuncert__1->SetBinError(8,0.01375991);
   EffRecoCorrSystSmoothuncert__1->SetBinError(9,0.01233412);
   EffRecoCorrSystSmoothuncert__1->SetBinError(10,0.01074953);
   ...
   EffRecoCorrSystSmoothuncert->SetBinError(1,0.01019307);
   EffRecoCorrSystSmoothuncert->SetBinError(2,0.01209986);
   EffRecoCorrSystSmoothuncert->SetBinError(3,0.01385834);
   EffRecoCorrSystSmoothuncert->SetBinError(4,0.01575793);
   EffRecoCorrSystSmoothuncert->SetBinError(5,0.01847541);
   EffRecoCorrSystSmoothuncert->SetBinError(6,0.01848607);
   EffRecoCorrSystSmoothuncert->SetBinError(7,0.01581257);
   EffRecoCorrSystSmoothuncert->SetBinError(8,0.01375991);
   EffRecoCorrSystSmoothuncert->SetBinError(9,0.01233412);
   EffRecoCorrSystSmoothuncert->SetBinError(10,0.01074953);
   ...
   MCsumRatio->SetBinContent(1,0.9854748);
   MCsumRatio->SetBinContent(2,0.9911977);
   MCsumRatio->SetBinContent(3,0.9923012);
   MCsumRatio->SetBinContent(4,1.00403);
   MCsumRatio->SetBinContent(5,1.00071);
   MCsumRatio->SetBinContent(6,0.9970916);
   MCsumRatio->SetBinContent(7,0.9948818);
   MCsumRatio->SetBinContent(8,0.9939201);
   MCsumRatio->SetBinContent(9,0.9976512);
   MCsumRatio->SetBinContent(10,0.9841611);
   MCsumRatio->SetBinError(1,0.01068717);
   MCsumRatio->SetBinError(2,0.01241167);
   MCsumRatio->SetBinError(3,0.01403787);
   MCsumRatio->SetBinError(4,0.01601789);
   MCsumRatio->SetBinError(5,0.0186473);
   MCsumRatio->SetBinError(6,0.0185955);
   MCsumRatio->SetBinError(7,0.01593767);
   MCsumRatio->SetBinError(8,0.01397186);
   MCsumRatio->SetBinError(9,0.01269695);
   MCsumRatio->SetBinError(10,0.01119969);
   MCsumRatio->SetEntries(45940.9);
