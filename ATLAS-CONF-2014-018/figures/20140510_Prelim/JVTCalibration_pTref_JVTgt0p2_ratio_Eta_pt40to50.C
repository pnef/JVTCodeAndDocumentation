...
//=========  (Sun May 11 01:24:22 2014) by ROOT version5.32/00
   TCanvas *c1 = new TCanvas("c1", "Histogram Drawing Options",452,113,600,800);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: pad1
   ...
   EffRecoCorrSystSmooth->SetBinContent(1,0.9530471);
   EffRecoCorrSystSmooth->SetBinContent(2,0.9555837);
   EffRecoCorrSystSmooth->SetBinContent(3,0.9588399);
   EffRecoCorrSystSmooth->SetBinContent(4,0.9669302);
   EffRecoCorrSystSmooth->SetBinContent(5,0.9655573);
   EffRecoCorrSystSmooth->SetBinContent(6,0.9625068);
   EffRecoCorrSystSmooth->SetBinContent(7,0.9772933);
   EffRecoCorrSystSmooth->SetBinContent(8,0.9677998);
   EffRecoCorrSystSmooth->SetBinContent(9,0.9571371);
   EffRecoCorrSystSmooth->SetBinContent(10,0.9633972);
   EffRecoCorrSystSmooth->SetBinError(1,0.01291843);
   EffRecoCorrSystSmooth->SetBinError(2,0.01109146);
   EffRecoCorrSystSmooth->SetBinError(3,0.009311727);
   EffRecoCorrSystSmooth->SetBinError(4,0.007745205);
   EffRecoCorrSystSmooth->SetBinError(5,0.007345369);
   EffRecoCorrSystSmooth->SetBinError(6,0.007271602);
   EffRecoCorrSystSmooth->SetBinError(7,0.00777995);
   EffRecoCorrSystSmooth->SetBinError(8,0.009081475);
   EffRecoCorrSystSmooth->SetBinError(9,0.01127584);
   EffRecoCorrSystSmooth->SetBinError(10,0.01311743);
   ...
   EffRecoCorr->SetBinContent(1,0.9530471);
   EffRecoCorr->SetBinContent(2,0.9555837);
   EffRecoCorr->SetBinContent(3,0.9588399);
   EffRecoCorr->SetBinContent(4,0.9669302);
   EffRecoCorr->SetBinContent(5,0.9655573);
   EffRecoCorr->SetBinContent(6,0.9625068);
   EffRecoCorr->SetBinContent(7,0.9772933);
   EffRecoCorr->SetBinContent(8,0.9677998);
   EffRecoCorr->SetBinContent(9,0.9571371);
   EffRecoCorr->SetBinContent(10,0.9633972);
   EffRecoCorr->SetBinError(1,0.006387286);
   EffRecoCorr->SetBinError(2,0.006315813);
   EffRecoCorr->SetBinError(3,0.005646066);
   EffRecoCorr->SetBinError(4,0.004525617);
   EffRecoCorr->SetBinError(5,0.004864414);
   EffRecoCorr->SetBinError(6,0.004772355);
   EffRecoCorr->SetBinError(7,0.00449102);
   EffRecoCorr->SetBinError(8,0.005158826);
   EffRecoCorr->SetBinError(9,0.006613845);
   EffRecoCorr->SetBinError(10,0.006574571);
   ...
   EffDataCorr->SetBinContent(1,0.9517165);
   EffDataCorr->SetBinContent(2,0.9579308);
   EffDataCorr->SetBinContent(3,0.9629629);
   EffDataCorr->SetBinContent(4,0.9678322);
   EffDataCorr->SetBinContent(5,0.9695247);
   EffDataCorr->SetBinContent(6,0.9689768);
   EffDataCorr->SetBinContent(7,0.9679069);
   EffDataCorr->SetBinContent(8,0.9590878);
   EffDataCorr->SetBinContent(9,0.9612815);
   EffDataCorr->SetBinContent(10,0.9494237);
   EffDataCorr->SetBinError(1,0.003181907);
   EffDataCorr->SetBinError(2,0.002619113);
   EffDataCorr->SetBinError(3,0.002263069);
   EffDataCorr->SetBinError(4,0.002019361);
   EffDataCorr->SetBinError(5,0.001962634);
   EffDataCorr->SetBinError(6,0.002036495);
   EffDataCorr->SetBinError(7,0.00207704);
   EffDataCorr->SetBinError(8,0.002406141);
   EffDataCorr->SetBinError(9,0.002488703);
   EffDataCorr->SetBinError(10,0.003227558);
...
// ------------>Primitives in pad: pad2
   ...
   EffRecoCorrSystSmoothuncert__1->SetBinError(1,0.01355487);
   EffRecoCorrSystSmoothuncert__1->SetBinError(2,0.011607);
   EffRecoCorrSystSmoothuncert__1->SetBinError(3,0.009711452);
   EffRecoCorrSystSmoothuncert__1->SetBinError(4,0.008010098);
   EffRecoCorrSystSmoothuncert__1->SetBinError(5,0.007607388);
   EffRecoCorrSystSmoothuncert__1->SetBinError(6,0.007554857);
   EffRecoCorrSystSmoothuncert__1->SetBinError(7,0.007960711);
   EffRecoCorrSystSmoothuncert__1->SetBinError(8,0.00938363);
   EffRecoCorrSystSmoothuncert__1->SetBinError(9,0.0117808);
   EffRecoCorrSystSmoothuncert__1->SetBinError(10,0.0136158);
   ...
   EffRecoCorrSystSmoothuncert->SetBinError(1,0.01355487);
   EffRecoCorrSystSmoothuncert->SetBinError(2,0.011607);
   EffRecoCorrSystSmoothuncert->SetBinError(3,0.009711452);
   EffRecoCorrSystSmoothuncert->SetBinError(4,0.008010098);
   EffRecoCorrSystSmoothuncert->SetBinError(5,0.007607388);
   EffRecoCorrSystSmoothuncert->SetBinError(6,0.007554857);
   EffRecoCorrSystSmoothuncert->SetBinError(7,0.007960711);
   EffRecoCorrSystSmoothuncert->SetBinError(8,0.00938363);
   EffRecoCorrSystSmoothuncert->SetBinError(9,0.0117808);
   EffRecoCorrSystSmoothuncert->SetBinError(10,0.0136158);
   ...
   MCsumRatio->SetBinContent(1,0.9986038);
   MCsumRatio->SetBinContent(2,1.002456);
   MCsumRatio->SetBinContent(3,1.0043);
   MCsumRatio->SetBinContent(4,1.000933);
   MCsumRatio->SetBinContent(5,1.004109);
   MCsumRatio->SetBinContent(6,1.006722);
   MCsumRatio->SetBinContent(7,0.9903955);
   MCsumRatio->SetBinContent(8,0.9909982);
   MCsumRatio->SetBinContent(9,1.00433);
   MCsumRatio->SetBinContent(10,0.9854956);
   MCsumRatio->SetBinError(1,0.01394161);
   MCsumRatio->SetBinError(2,0.01195397);
   MCsumRatio->SetBinError(3,0.01003473);
   MCsumRatio->SetBinError(4,0.008285104);
   MCsumRatio->SetBinError(5,0.007904464);
   MCsumRatio->SetBinError(6,0.00789446);
   MCsumRatio->SetBinError(7,0.00816568);
   MCsumRatio->SetBinError(8,0.009625776);
   MCsumRatio->SetBinError(9,0.01211414);
   MCsumRatio->SetBinError(10,0.01383022);
   MCsumRatio->SetEntries(88385.67);
